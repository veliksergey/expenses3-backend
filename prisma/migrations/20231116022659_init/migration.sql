...
CREATE TABLE "Record" (
    ...
    "notesCount" SMALLINT NOT NULL DEFAULT 0,
    "documentsCount" SMALLINT NOT NULL DEFAULT 0,
...
-- CreateTable
CREATE TABLE "StatusesOnTypes" (
    "typeId" INTEGER NOT NULL,
    "statusId" INTEGER NOT NULL,
    "active" BOOLEAN NOT NULL DEFAULT true,
    "order" SMALLINT,

    CONSTRAINT "StatusesOnTypes_pkey" PRIMARY KEY ("typeId","statusId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Type_enum_key" ON "Type"("enum");
...
-- AddForeignKey
ALTER TABLE "StatusesOnTypes" ADD CONSTRAINT "StatusesOnTypes_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "Type"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StatusesOnTypes" ADD CONSTRAINT "StatusesOnTypes_statusId_fkey" FOREIGN KEY ("statusId") REFERENCES "Status"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
